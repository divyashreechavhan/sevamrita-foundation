...
function Story() {
  const events = useMemo(() => [
    ...
    { direction: 'l', date: '2022', title: 'Conducted Leadership Training', image: '/images/story4.jpg', description: 'At SSPU, Pune, we organized an institute-wide leadership training seminar attended by nearly 300 students.' },
    { direction: 'r', date: '2023', title: 'Workshop Personality Development', image: '/images/story5.jpg', description: 'At SVNIT, Surat, we hosted a personality development workshop with around 250 participants.' }
  ], []);
