...
function Story() {
  const events = useMemo(() => [
    ...
    { direction: 'l', date: '2024', title: 'Sevamrita is formally registered', image: '/images/NGO_Image.jpg', description: 'With focus on long term vision and a goal to get CSR funds for impact projects,Sevamrita is registered as asection 8 company.' },
    { direction: 'r', date: '2025', title: 'Activities expand to 2 new cities',image: '/images/NGO_expansion.jpg' , description: 'Sevamrita is expanding its reach to Amravati and Gurgaon' },
